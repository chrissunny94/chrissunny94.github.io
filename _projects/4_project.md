...
description: How to go about thinking of a E2E stack
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/blog/4/BEV_PLANNER.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
